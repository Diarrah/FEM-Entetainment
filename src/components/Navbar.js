    ...
    return (
        <div className="navbar">
            ...
            <div className="navbar__links">
                <Link to="/">
                    <svg className="navbar__links--icon" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to="/bookmarks">
                    <svg className="navbar__links--icon" width="17" height="20" xmlns="http://www.w3.org/2000/svg">
